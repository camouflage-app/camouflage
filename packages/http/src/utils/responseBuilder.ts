...
export const responseBuilder = (mockFilePath: string, helpers: any, request: express.Request, response: express.Response): CamouflageResponse => {
    let delay = 0;
    ...
    const body: string = decodeHTMLEntities(bodyStr);
